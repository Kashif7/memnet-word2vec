...
flags.DEFINE_integer("num_epoch", 50, "training epochs")
...
# define data
data = GenData('data/tasks_1-20_v1-2/en', memory_size = Flags.memory_size, description_size = Flags.description_length, vocab_size = Flags.vocab_size, taskid = 1)
